...
/*
while문 : 반복의 횟수가 명확히 정해져 있지 않았을 때 주로 사용하는 반복문으로 반복을 위한
초기값, 조건, 증감식을 따로 작성하는 형식을 가지고 있다.
[형식]
	반복을 위한 변수의 초기값;
	while (반복의 조건) {
		실행문장;
...
조건이 true일 때 반복하고, 반복문의 처음으로 돌아가면 조건을 확인한다. 반복의 조건이 false일
때 탈출한다.
 */
public class E03While {
	...
	public static void main(String[] args) {
		...
		/*
		[시나리오] 1~100까지의 정수 중 3의 배수이거나 4의 배수인 정수의 합을 구하는
		프로그램을 while문을 이용해서 작성하시오.
		 */
		int total = 0;
		int k = 1;
