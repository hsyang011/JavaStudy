...
public class Ex06Define3Consumer {
	...
	public static void main(String[] args) {
		/* Consumer<T> : 소비자라는 뜻을 가지고 있어 매개변수는 있으나 반환값이 없는
		accept()추상메소드가 정의되어 있다.
		즉 매개변수를 소비하는 형태라 보면 되고, 리턴값이 없으므로 단순한 출력결과만
		보여준다.
		...
		Consumer<String>와 같이 정의했으므로 매개변수 타입이 String임을 유추할 수
		있어 생략이 가능하다. */
