...
public class Ex08AsList {
	...
	public static void listPrint(String title, List<String> list) {
		...
		/* 출력할 객체가 String이므로 별도의 오버라이딩 없이도 내용을 출력할 수 있다.
	...
	public static void main(String[] args) {
		/* String객체 배열을 생성과 동시에 초기화한다. 이 경우 초기데이터를 토앻 크기를
		유추할 수 있으므로 크기는 선언문장에서 생략해야 한다. */
...
//		list.add("탱크"); // 에러발생
		...
		// ArrayList<E>의 생성자를 통해 앞의 객체를 복사하면 데이터를 변경할 수 있다.
		...
		/* Set<E>컬렉션은 중복을 허용하지 않으므로 List에 저장된 중복값을 제거할 수
		있다. */
