...
/* 클래스 생성시 정렬의 기준을 만들어주기 위해서는 Comparable<T>인터페이스를 구현해야
한다. */
class MyString implements Comparable<MyString> {
	...
	정렬의 기준은 단순하게 가나다라와 같은 순서가 될 수도 있고, 문자열의 길이에 따른 정렬이
	될 수도 있다. 아래의 코드는 오름차순(작은 것-> 큰 것) 정렬일 때 사용한다.
