...
public class DBConnect {
	...
	public static void main(String[] args) {
		/* JDBC프로그래밍 절차
		1. 오라클용 JDBC드라이버를 메모리에 로드한다 : new를 사용하지 않고 클래스명으로
		직접 객체를 생성한 후 모메리에 로드하는 forName()이라는 정적메소드를 사용한다.
		...
		3. DriverManager클래스의 정적메소드인 getConnection()을 통해
		데이터베이스에 연결을 시도하고, 연결에 성공하면 Connection객체를 반환한다.
