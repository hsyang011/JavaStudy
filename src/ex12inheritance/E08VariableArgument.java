...
/* 가변인자(Variable Argument) : 메소드 오버로딩을 대체할 수 있는 문법으로 하나의
...
[형식]
	...
	- 매개변수를 2개 이상 받을 수 있어야 하므로 배열로 반환
	- 단, 자료형은 모두 동일해야 한다. */
public class E08VariableArgument {
	...
	또한 메소드 내에서는 배열로 반환되어 매개변수명.length와 같이 사용할 수 있다. */
	static int getTotal(int ... param) {
		int total = 0;
	...
	public static void main(String[] args) {
		...
		/* 매개변수의 타입이 double이 포함되어 있으므로 호출할 수 없다. 만약 아래와
		같이 실수를 모두 처리하려면 가변인자의 타입을 double로 선언하면 된다. */
//		System.out.println("getTotal(args1, args2)호출:" +
//				getTotal(10, 20.3));
	}
