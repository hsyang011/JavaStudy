...
비교를 하는것이므로, 실제 내용에 대한 비교가 이루어지지 않는다.
- 인스턴스간의 내용 비교를 위해서는 equals()메소드를 각 클래스에 맞게 오버라이딩하여
사용해야 한다.
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		/* 개발자가 직접 정의한 myEquals()메소드를 통해 객체간의 내용비교를 한다.
		여기서는 다르다는 결과가 출력된다. */
		...
		/* 인스턴스간의 비교를 할때는 단순히 참조변수에 대한 비교를 하면 안되고, 실제
		내용에 대한 비교를 해야한다. */
